...
// node_modules/lit-flatpickr/node_modules/@lit/reactive-element/development/css-tag.js
var NODE_MODE = false;
...
// node_modules/lit-flatpickr/node_modules/@lit/reactive-element/development/reactive-element.js
var _a;
var _b;
var _c;
var _d;
...
// node_modules/lit-flatpickr/node_modules/lit-html/development/lit-html.js
var _a2;
var _b2;
var _c2;
var _d2;
...
// node_modules/lit-flatpickr/node_modules/lit-element/development/lit-element.js
var _a3;
var _b3;
var _c3;
var DEV_MODE3 = true;
...
// node_modules/lit-flatpickr/node_modules/@lit/reactive-element/development/decorators/custom-element.js
...
// node_modules/lit-flatpickr/node_modules/@lit/reactive-element/development/decorators/property.js
...
// node_modules/lit-flatpickr/node_modules/@lit/reactive-element/development/decorators/query-assigned-elements.js
var _a4;
...
var createDateFormatter = function(_a5) {
  var _b4 = _a5.config, config = _b4 === void 0 ? defaults : _b4, _c4 = _a5.l10n, l10n = _c4 === void 0 ? english : _c4, _d3 = _a5.isMobile, isMobile = _d3 === void 0 ? false : _d3;
...
var createDateParser = function(_a5) {
  var _b4 = _a5.config, config = _b4 === void 0 ? defaults : _b4, _c4 = _a5.l10n, l10n = _c4 === void 0 ? english : _c4;
  return function(date, givenFormat, timeless, customLocale) {
    ...
    if (date instanceof Date)
      ...
      if (datestr === "today") {
        ...
        ops.forEach(function(_a6) {
          var fn = _a6.fn, val = _a6.val;
...
function FlatpickrInstance(element, instanceConfig) {
  ...
  function getClosestActiveElement() {
    var _a5;
    return ((_a5 = self.calendarContainer) === null || _a5 === void 0 ? void 0 : _a5.getRootNode()).activeElement || document.activeElement;
  }
  ...
  function build() {
    ...
    if (!self.config.noCalendar) {
      ...
      if (self.config.weekNumbers) {
        var _a5 = buildWeeks(), weekWrapper = _a5.weekWrapper, weekNumbers = _a5.weekNumbers;
  ...
  function clear(triggerChangeEvent, toInitial) {
    ...
    if (self.config.enableTime === true) {
      var _a5 = getDefaultHours(self.config), hours = _a5.hours, minutes = _a5.minutes, seconds = _a5.seconds;
      setHours(hours, minutes, seconds);
    }
    self.redraw();
  ...
  function isEnabled(date, timeless) {
    ...
    if (dateToCheck === void 0)
      return false;
    var bool = !!self.config.enable, array = (_a5 = self.config.enable) !== null && _a5 !== void 0 ? _a5 : self.config.disable;
  ...
  function getDateStr(specificFormat) {
    ...
    }).filter(function(d2, i, arr) {
      return self.config.mode !== "range" || self.config.enableTime || arr.indexOf(d2) === i;
...
var LitFlatpickr = class LitFlatpickr2 extends LitElement {
  constructor() {
    super(...arguments);
    this.placeholder = "";
  ...
  checkForSlottedElement() {
    var _a5;
    const slottedElem = (_a5 = this.shadowRoot) === null || _a5 === void 0 ? void 0 : _a5.querySelector("slot");
  ...
  async initializeComponent() {
    ...
    if (this._hasSlottedElement) {
      ...
      inputElement = (_a5 = this.shadowRoot) === null || _a5 === void 0 ? void 0 : _a5.querySelector("input");
    }
    if (inputElement) {
  ...
  render() {
    return html`
      ${!this._hasSlottedElement ? html`<input class="lit-flatpickr flatpickr flatpickr-input" placeholder=${this.placeholder} />` : html``}
      <slot></slot>
    `;
  }
};
...
@lit/reactive-element/development/decorators/query-assigned-elements.js:
   ...
   *)
*/
//# sourceMappingURL=lit-flatpickr.js.map
